...
import { FaArrowLeft, FaStar, FaTruck, FaShieldAlt, FaUndo } from 'react-icons/fa'
      ...
      <header className="sticky top-0 z-30 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-4 sm:px-6 lg:px-8">
          <button
            ...
            className="cursor-pointer flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-100 active:scale-95"
          >
            <FaArrowLeft size={15} />
            Back
          </button>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="group relative flex h-87 items-center justify-center overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm sm:h-112.5 lg:h-140">
              ...
              <button className="absolute cursor-pointer right-4 top-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-white text-xl text-gray-400 shadow-md transition-all duration-200 hover:bg-red-50 hover:text-red-500">
                ♡
              </button>
              <img
                className="h-full w-full object-contain p-8 transition-transform duration-500 group-hover:scale-105 cursor-pointer"
          ...
          <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-7 lg:p-8">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-1.5 rounded-lg bg-yellow-50 px-3 py-1.5">
                ...
                <span className="text-sm font-bold text-gray-800">
                  {cartItem[0].rating.stars}
                </span>
              </div>
              <span className="text-sm text-gray-500">
                {cartItem[0].rating.count}
              </span>
              <span className="text-gray-300">•</span>
            ...
            <div>
              ...
              <div className="flex w-fit items-center overflow-hidden rounded-xl border border-gray-300 bg-white">
                <button className="flex h-10 w-11 items-center justify-center text-xl text-gray-600 transition hover:bg-gray-100">
                  −
                </button>
            ...
            <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
              <button className="rounded-xl cursor-pointer border-2 border-blue-600 bg-blue-600 py-3 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-blue-700 hover:shadow-md active:scale-[0.98]">
                Add to Cart
              </button>
              <button className="rounded-xl cursor-pointer border-2 border-green-600 bg-green-600 py-3 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-green-700 hover:shadow-md active:scale-[0.98]">
                Buy Now
              </button>
            </div>
